...
- [hibernate OneToOne mapping (unidirectional)](#hibernate-onetoone-mapping-unidirectional)
...
# hibernate OneToOne mapping (unidirectional)
...
* create an instructor with its instructor details
* create just an instrcutor
* create just an instructor detail (we already have the isntructor) and link it to its instructor
* get the instructor details
* update an instctrucotr
* updtae an instctor detail
* delete an instructor
* delete an instructor detail
...
* create a class named **Instructor**
    ...
    **@JoinColumn** means that a column named **instructor_detail_id** will be created in the **instructors** table (and will point to the instructor's details.)
...
* create an instructor with its details
